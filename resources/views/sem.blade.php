    ...
    <section id="service-inner-page-2nd" class="ptb">
         <div class="container-fluid res-container">
             <div class="row mx-md-5 mx-lg-5 g-4">
                     ...
                     <div class="col-md-5">
                         <div class="card-header mb-3">Search Engine</div>
                         <div class="card-body">
                             <h3>Targeted SEM Campaigns</h3>
                         </div>
                     </div>
                     <div class="col-md-7">
                        <p>Precision-targeted SEM campaigns that leverage data-driven insights to maximize your ROI and drive immediate traffic and leads.</p>
                     </div>
                </div>
           </div>
     </section>    
