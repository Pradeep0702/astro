<x-adminlayout title="Service Category"> 
    <div class="content-wrapper">   
        <div>
            <a href="{{route('service-category.create')}}" class="btn btn-primary f-14"><i class="fas fa-plus"></i> Add Category</a>
        </div>   
...
<script>  
    ...
    const tabledata = new DataTable('#datatable', {
     ajax: '{{route('service-category.getdata')}}',
     processing: true,
     serverSide: true,   
     columns: [ 
            { data:'index'},
    ...
    function changeorder(){
        ...
        $.ajax({
            url:"{{route('service-category.order')}}",
            type:'GET',
            data:{'id':newdataid},
...
<x-delete href="service-category.delete"/>
@endpush   
 </x-adminlayout>
