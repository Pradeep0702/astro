    ...
    <section id="service-inner-page-2nd" class="ptb">
         <div class="container-fluid res-container">
             <div class="row mx-md-5 mx-lg-5 g-4">
                     ...
                     <div class="col-md-5">
                         <div class="card-header mb-3">Unique</div>
                         <div class="card-body">
                             <h3>Distinctive Brand Identities</h3>
                         </div>
                     </div>
                     <div class="col-md-7">
                        <p>Custom logo designs that capture your brand essence, ensuring a memorable and impactful first impression.</p>
                     </div>
                </div>
           </div>
     </section>    
